  ...
  return (
    <AbsoluteFill style={{...full, padding: '120px 140px', justifyContent: 'center'}}>
      ...
      <div style={{position: 'relative', width: 1120}}>
        <FadeIn><Pill green>v0.2.1 · Windows x64 社区发行</Pill></FadeIn>
        ...
        <FadeIn delay={54}><div style={{color: colors.muted, fontSize: 25, marginTop: 28}}>社区封装，非 DeepSeek 官方产品</div></FadeIn>
      </div>
    </AbsoluteFill>
  );
};

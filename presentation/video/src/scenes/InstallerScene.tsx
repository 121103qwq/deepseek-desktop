...
export const InstallerScene = () => (
  <AbsoluteFill style={{...full, padding: '95px 110px', flexDirection: 'row', alignItems: 'center', gap: 100}}>
    <div style={{width: 690}}>
      ...
      <FadeIn delay={25}><div style={subtitle}>默认选中 Kilo Auto Free；也可以选择 DeepSeek API，之后在应用内填写自己的 Key。</div></FadeIn>
      <FadeIn delay={42}><div style={{marginTop: 38, display: 'flex', gap: 18, flexWrap: 'wrap'}}><Pill green>免登录</Pill><Pill>不是本地模型</Pill><Pill>可选桌面快捷方式</Pill></div></FadeIn>
    </div>
